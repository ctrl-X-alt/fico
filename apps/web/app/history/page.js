...
export default function History(){
 ...
 return <main className="shell"><nav className="nav"><div className="brand">Friction</div><a href="/analysis/new">New analysis</a></nav><div className="eyebrow">Diagnostic Dossier</div><h1>History</h1>
